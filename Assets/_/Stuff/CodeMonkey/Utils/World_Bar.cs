...
//             if (transform.Find("Outline") != null) {
//                 // Has outline
//                 transform.Find("Outline").GetComponent<SpriteRenderer>().sortingLayerName = sortingLayerName;
//             }

//             //Background
//             background.GetComponent<SpriteRenderer>().sortingLayerName = sortingLayerName;

//             Transform barIn = bar.Find("BarIn");
//             barIn.GetComponent<SpriteRenderer>().sortingLayerName = sortingLayerName;
//         }
